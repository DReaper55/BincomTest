...
class AnnouncedStateResult {
    constructor({ result_id, state_name, party_abbreviation, party_score, entered_by_user, date_entered, user_ip_address }) {
  ...
  module.exports = AnnouncedStateResult;
